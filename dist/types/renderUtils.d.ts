...
export declare function renderText(ctx: CanvasRenderingContext2D, text: string, left: number, top: number, width: number, height: number, textAlign?: TEXT_ALIGN, verticalAlign?: VERTICAL_ALIGN, ellipsisChar?: string, cacheNode?: {
    cache?: {
        text: string;
        width: number;
        value: string;
...
export declare function renderMultilineText(ctx: CanvasRenderingContext2D, text: string, left: number, top: number, width: number, height: number, lineHeight: number, textAlign?: TEXT_ALIGN, verticalAlign?: VERTICAL_ALIGN, maxLines?: number, ellipsisChar?: string): void;
