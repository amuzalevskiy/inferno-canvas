...
let documentCreateElement$1 = documentCreateElement;
...
function mountElement(vNode, parentDOM, context, isSVG, nextNode, lifecycle) {
    ...
    let children = vNode.children;
    const childFlags = vNode.childFlags;
    const dom = (vNode.dom = documentCreateElement$1(vNode.type, (isSVG = isSVG || (flags & 32 /* SvgElement */) > 0)));
...
export { Component, EMPTY_OBJ, Fragment, createClassComponentInstance as _CI, normalizeRoot as _HI, mount as _M, mountClassComponentCallbacks as _MCCC, mountElement as _ME, mountFunctionalComponentCallbacks as _MFCC, mountProps as _MP, mountRef as _MR, __render, createComponentVNode, createFragment, createPortal, createRef, createRenderer, createTextVNode, createVNode, directClone, findDOMfromVNode, forwardRef, getFlagsForElementVnode, linkEvent, normalizeProps, options, render, rerender, setCreateElementFunction, version };
